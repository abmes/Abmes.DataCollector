...
Execute unit tests
```
    cd "Abmes.DataCollector.Vault.AmazonLambda/test/Abmes.DataCollector.Vault.AmazonLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "Abmes.DataCollector.Vault.AmazonLambda/src/Abmes.DataCollector.Vault.AmazonLambda"
