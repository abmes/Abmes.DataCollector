...
namespace Abmes.DataCollector.Collector.Logging
{
    public static class ContainerRegistrations
    {
        public static void RegisterFor(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Configuration.DataCollectConfigsProvider>().Named<IDataCollectConfigsProvider>("LoggingDecorator");
            ...
            builder.RegisterDecorator<IDataCollectConfigsProvider>((x, inner) => x.ResolveNamed<IDataCollectConfigsProvider>("LoggingDecorator", TypedParameter.From(inner)), "dateFormatting").As<IDataCollectConfigsProvider>();
