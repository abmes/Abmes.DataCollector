...
public static class HttpClientExtensions
{
    ...
    public static async Task<string> CheckedGetStringAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        using var response = await httpClient.CheckedGetAsync(url, headers: headers, cancellationToken: cancellationToken);
    ...
    public static async Task<TResult?> GetNullableFromPostAsJsonAsync<TResult, TValue>(
        ...
        where TResult : class?
    {
        using var response = await client.PostAsJsonAsync(requestUri, value, cancellationToken);
    ...
    public static void SetBaseAddress(this HttpClient client, string baseAddress)
    {
